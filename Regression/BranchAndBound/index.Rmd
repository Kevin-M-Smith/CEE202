...
<br><br>
Consider the case where $p = 12$, and the objective is to solve for the best model at each level $d \in 1...P$ A brute force search would require evaluating all $\sum_{i=1}^{12} \tbinom {12}{i} = `r sum(choose(12,1:12))`$ models. With modern computers, this is feasible in a reasonable time frame. However, if $p$ is increased by 50% to 18 predictors, the total number of models becomes $\sum_{i=1}^{18} \tbinom {18}{i} = `r sum(choose(18,1:18))`$. Clearly things get out of hand pretty quickly. 
